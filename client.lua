...
addCommandHandler("crud",function(cmd,player) 
    -- triggerServerEvent("onClientInsertUser",root,localPlayer,"Vadymko","Alkovich","Selo")
    -- triggerServerEvent("onClientUpdateUser",root,localPlayer,11,"Bakbarich","Mahkid","Jinjin")
    -- triggerServerEvent("onClientDeleteUser",root,localPlayer,11)
